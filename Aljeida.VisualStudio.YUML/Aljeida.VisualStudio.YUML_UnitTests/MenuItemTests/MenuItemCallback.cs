...
using Aljeida.VisualStudio.YUML;

namespace Aljeida.VisualStudio.YUML_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new YUMLPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(Aljeida.VisualStudio.YUML.GuidList.guidAljeida_VisualStudio_YUMLCmdSet, (int)Aljeida.VisualStudio.YUML.PkgCmdIDList.cmdidViewClassDiagramByYUML);
