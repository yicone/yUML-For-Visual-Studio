...
namespace Aljeida.VisualStudio.YUML_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(Aljeida.VisualStudio.YUML.GuidList.guidAljeida_VisualStudio_YUMLCmdSet, (int)Aljeida.VisualStudio.YUML.PkgCmdIDList.cmdidViewClassDiagramByYUML);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "YUML", "Aljeida.Aljeida_VisualStudio_YUML.Aljeida_VisualStudio_YUMLPackage");
